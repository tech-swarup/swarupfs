...
export class PostService {
  ...
  getPosts() {
    ...
    this.http.get<{ message: string, posts: any }>('https://studnodefile.herokuapp.com/api/posts')
  ...
  addPost(title: string, content: string, image: File) {
    ...
    this.http.post<{ message: string, post: Post }>('https://studnodefile.herokuapp.com/api/posts', postData)
  ...
  deletePost(postId: string) {
    this.http.delete('https://studnodefile.herokuapp.com/api/posts/' + postId)
  ...
  getPost(id: string) {
    ...
    return this.http.get<{ _id: string, title: string, content: string, imagePath: string }>("https://studnodefile.herokuapp.com/api/post/" + id)
  ...
  updatedPost(id: string, title: string, content: string, image: File | string) {
    ...
    this.http.put('https://proswarup.herokuapp.com/api/post/' + id, postData)
      .subscribe((response) => {
